...
const uload = resolve => require(['@/components/back/uload'], resolve)
...
const Project = resolve => require(['@/components/front/project'], resolve)
...
const router = new Router({
    ...
    routes: [{
        ...
        children: [
            ...
            { path: 'project', name: 'project', component: Project, meta: { title: '项目' } },
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'uload', name: 'uload', component: uload, meta: { requireAuth: true, title: '上传图片' } },
